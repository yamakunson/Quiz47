  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.container2}>
        <Text style={styles.line1}>Get Started</Text>
        <Text style={styles.line2}>Go and enjoy our features for free and make your life easier.</Text>
        <Button onPress={() => props.onNavigate(RootScreens.MAIN)} style={styles.nextbutton}>
